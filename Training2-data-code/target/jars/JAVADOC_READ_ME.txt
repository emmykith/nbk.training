...
NOTE : If the double-click do not work, this is due to the fact that the .jar
...
To do so, use tJavadocMerger of your <tafj_home>/bin directory.
There is 2 different syntax for the javadocMerger.

Syntax 1 : JavaDocMerger <directory_of_*.javadoc.jar> [<new_jar_name>]
...
example : ./tJavadocMerger /home/user/myT24/jars ASingleDoc.javadoc.jar

Syntax 2 : JavaDocMerger -merge <List of *.javadoc.jar> -o <new_jar_name>
This one allows you to specify the files you want to merge and the full path of the result.
example 1 : ./tJavadocMerger ./AA_Account.javadoc.jar ./AC_Account.javadoc.jar -o /home/user/doc/Account.javadoc.jar
example 2 : ./tJavadocMerger ./T24/jars/AA*.javadoc.jar /home/user/doc/AA.javadoc.jar
